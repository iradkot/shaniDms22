...
Create the following repository secrets before running the workflow. Values that contain binary
content must be Base64 encoded so they can be injected as plain text at runtime.
