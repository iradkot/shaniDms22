...
const en = {
  ...
  trends: {
    ...
    dayQualityPatterns: 'Day Quality & Patterns',
    highestTir: 'Highest TIR',
    lowestTir: 'Lowest TIR',
    fewestHypos: 'Fewest Hypos',
    mostHypos: 'Most Hypos',
    fewestHypers: 'Fewest Hypers',
    mostHypers: 'Most Hypers',
    bestDay: 'Best Day ({{metric}}):',
    worstDay: 'Worst Day ({{metric}}):',
    na: 'N/A',
    daySummaryLine: 'TIR: {{tir}}% | Hypos: {{hypos}} | Hypers: {{hypers}}',
    bestDayInsights: 'Best Day Insights',
    worstDayInsights: 'Worst Day Insights',
    date: 'Date:',
    avgBgLabel: 'Avg BG:',
    tirPctLabel: 'TIR (%):',
    minBgLabel: 'Min BG:',
    maxBgLabel: 'Max BG:',
    timeBelowRange: 'Time Below Range:',
    timeAboveRange: 'Time Above Range:',
    bestDayTip: 'Stable overnight? Good meal timing? Learn from this pattern.',
    worstDayTip: 'Identify causes: Late meals? Missed bolus? Stress?',
    highBolusIob: 'High bolus IOB',
    highBasalIob: 'High basal IOB',
    basalDriven: 'Basal-driven',
    bolusDriven: 'Bolus-driven',
    duration: 'Duration',
    atNadir: 'At nadir',
    bolus: 'Bolus',
    carbs: 'Carbs',
    during: 'during',
    severeHyposRange: 'Severe hypos: events < {{threshold}} mg/dL',
    avgDuration: 'Avg duration: {{value}}',
    loadingHypos: 'Loading hypos…',
  ...
  settings: {
    ...
    mealWindows: 'Meal windows',
    breakfastStart: 'Breakfast start (0–23)',
  ...
  notificationForm: {
    ...
    rangeStartPlaceholder: 'e.g. 80',
    rangeEndLabel: 'Range End',
    rangeEndPlaceholder: 'e.g. 180',
    enabled: 'Enabled',
    disabled: 'Disabled',
    from: 'From {{time}}',
    to: 'To {{time}}',
    trendLabel: 'Trend',
    trendInfo:
      'The trend determines when this notification will trigger:\n• Down: Only when glucose is falling fast or slow.\n• Up: Only when glucose is rising fast or slow.\n• Flat: Trend is ignored, triggers at any direction.',
    errRequired: '{{label}} is required',
    errMinLength: '{{label}} must be at least 3 characters',
    errMaxLength: '{{label}} must be at most 50 characters',
    errMin: '{{label}} must be at least 1',
    errMax: '{{label}} must be at most 1000',
    errNumber: '{{label}} must be a number',
    errRangeOrder: 'Range Start must be lower than Range End',
    errTimeWindow: 'From and To cannot be the same time',
    hourFromRequired: 'Hour From is required.',
    hourToRequired: 'Hour To is required.',
    trendRequired: 'Trend is required.',
  },
  notificationScreens: {
...
const he: typeof en = {
  ...
  trends: {
    ...
    dayQualityPatterns: 'איכות יום ודפוסים',
    highestTir: 'TIR הכי גבוה',
    lowestTir: 'TIR הכי נמוך',
    fewestHypos: 'הכי מעט היפו',
    mostHypos: 'הכי הרבה היפו',
    fewestHypers: 'הכי מעט היפר',
    mostHypers: 'הכי הרבה היפר',
    bestDay: 'היום הטוב ביותר ({{metric}}):',
    worstDay: 'היום הקשה ביותר ({{metric}}):',
    na: 'לא זמין',
    daySummaryLine: 'TIR: {{tir}}% | היפו: {{hypos}} | היפר: {{hypers}}',
    bestDayInsights: 'תובנות מהיום הטוב ביותר',
    worstDayInsights: 'תובנות מהיום הקשה ביותר',
    date: 'תאריך:',
    avgBgLabel: 'ממוצע סוכר:',
    tirPctLabel: 'TIR (%):',
    minBgLabel: 'סוכר מינימום:',
    maxBgLabel: 'סוכר מקסימום:',
    timeBelowRange: 'זמן מתחת לטווח:',
    timeAboveRange: 'זמן מעל הטווח:',
    bestDayTip: 'לילה יציב? תזמון ארוחות טוב? אפשר ללמוד מהדפוס הזה.',
    worstDayTip: 'זהו גורמים: ארוחות מאוחרות? בולוס חסר? סטרס?',
    highBolusIob: 'IOB בולוס גבוה',
    highBasalIob: 'IOB בזאל גבוה',
    basalDriven: 'מונע בזאל',
    bolusDriven: 'מונע בולוס',
    duration: 'משך',
    atNadir: 'בשפל',
    bolus: 'בולוס',
    carbs: 'פחמימות',
    during: 'במהלך',
    severeHyposRange: 'היפו חמור: אירועים < {{threshold}} mg/dL',
    avgDuration: 'משך ממוצע: {{value}}',
    loadingHypos: 'טוען אירועי היפו…',
  ...
  settings: {
    ...
    mealWindows: 'חלונות ארוחות',
    breakfastStart: 'תחילת בוקר (0–23)',
    ...
    errMealHoursRange: 'שעות התחלת ארוחות חייבות להיות בין 0 ל-23.',
    errMealHoursOrder: 'שעות הארוחות חייבות להיות בסדר: בוקר < צהריים < ערב.',
  ...
  notificationForm: {
    ...
    rangeStartLabel: 'טווח התחלה',
    rangeStartPlaceholder: 'למשל 80',
    rangeEndLabel: 'טווח סיום',
    rangeEndPlaceholder: 'למשל 180',
    enabled: 'פעילה',
    disabled: 'כבויה',
    from: 'מ־{{time}}',
    to: 'עד {{time}}',
    trendLabel: 'מגמה',
    trendInfo:
      'המגמה קובעת מתי ההתראה תופעל:\n• ירידה: רק כשהסוכר יורד (מהר או לאט).\n• עלייה: רק כשהסוכר עולה (מהר או לאט).\n• יציב: מתעלם ממגמה, מפעיל בכל כיוון.',
    errRequired: 'חובה למלא {{label}}',
    errMinLength: '{{label}} חייב להכיל לפחות 3 תווים',
    errMaxLength: '{{label}} יכול להכיל עד 50 תווים',
    errMin: '{{label}} חייב להיות לפחות 1',
    errMax: '{{label}} חייב להיות עד 1000',
    errNumber: '{{label}} חייב להיות מספר',
    errRangeOrder: 'ערך ההתחלה חייב להיות קטן מערך הסיום',
    errTimeWindow: 'שעת התחלה וסיום לא יכולות להיות זהות',
    hourFromRequired: 'חובה לבחור שעת התחלה.',
    hourToRequired: 'חובה לבחור שעת סיום.',
    trendRequired: 'חובה לבחור מגמה.',
  },
  notificationScreens: {
    addTitle: 'הוספת התראה',
    addSubmit: 'הוסף',
